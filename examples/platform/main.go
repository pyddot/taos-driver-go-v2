...
import (
	...
	_ "github.com/pyddot/taos-driver-go-v2/taosRestful"
	"github.com/pyddot/taos-driver-go-v2/types"
)

func main() {
	db, err := sql.Open("taosRestfulv2", "root:taosdata@http(192.168.1.163:8085)/?token=c37ef4dbec8708c0227b4e8cb84ffffb9b8711a1")
	if err != nil {
		panic(err)
	}
